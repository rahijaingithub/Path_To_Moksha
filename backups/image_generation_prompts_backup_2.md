...
*   **`level2_background.png`** (The Mountain Ascent)
    *   **Prompt:** `Hyper-realistic cinematic landscape of a steep mountain ascent at twilight. Rocky staircases carved into the mountain side, a brilliant starry night sky, glowing warm oil lanterns lining the path, high-resolution 8k, highly detailed rock textures, atmospheric depth.`
