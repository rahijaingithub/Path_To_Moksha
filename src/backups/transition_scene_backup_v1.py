...
from settings import (
    LOGICAL_WIDTH, LOGICAL_HEIGHT, SCENE_LEVEL, SCENE_TITLE,
...
class TransitionScene(Scene):
    ...
    def draw(self, surface):
        ...
        if self.elapsed > 1.8:
            ...
            if getattr(self, "to_be_continued", False):
                prompt_text = "To be continued... (Press ENTER or Tap to return to Main Menu)"
                color = COLOR_SAFFRON
            else:
                prompt_text = "Press ENTER or Tap to continue..."
                color = COLOR_WHITE
            cont = self.font_small.render(prompt_text, True, color)
