    ...
    def draw(self, surface):
        ...
        for plat in self.platforms:
            ...
            if self.game_mode == "standard":
                glow_surf = pygame.Surface((plat.width, 10), pygame.SRCALPHA)
                # Outer thick soft gold glow
                pygame.draw.line(glow_surf, (255, 215, 0, 70), (0, 3), (plat.width, 3), 6)
                # Middle medium gold glow
                pygame.draw.line(glow_surf, (255, 225, 30, 140), (0, 3), (plat.width, 3), 4)
                # Inner bright gold core
                pygame.draw.line(glow_surf, (255, 255, 200, 255), (0, 3), (plat.width, 3), 2)
                
                gameplay_surf.blit(glow_surf, (plat.left, plat.top - 3))
                continue
