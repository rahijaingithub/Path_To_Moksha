...
class Monk:
    ...
    def draw_dialogue(self, surface, font_title, font_body, font_small):
        ...
        pygame.draw.rect(surface, COLOR_GOLD, (bx - 12, by - 12, 24, box_h + 24), width=2.5, border_radius=6)
        # Right Roller Cylindrical scroll roll
        pygame.draw.rect(surface, (120, 80, 40), (bx + box_w - 12, by - 12, 24, box_h + 24), border_radius=6)
        pygame.draw.rect(surface, COLOR_GOLD, (bx + box_w - 12, by - 12, 24, box_h + 24), width=2.5, border_radius=6)
        ...
        pygame.draw.rect(surface, (210, 185, 145), (bx + 8, by + 8, box_w - 16, box_h - 16), width=1.5, border_radius=2)
        ...
        for i, choice in enumerate(q["choices"]):
            ...
            if is_sel:
                ...
                pygame.draw.rect(hl, (220, 110, 20, 150), hl.get_rect(), width=1.5, border_radius=10)
