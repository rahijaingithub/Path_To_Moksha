...
class LevelScene(Scene):
    ...
    def draw(self, surface):
        ...
        for plat in self.platforms:
            ...
            # Standard mode: platforms are invisible (they still collide — only drawing is skipped)
        ...
        if strip:
            ...
            disp_w = int(self.player.width  * self.player.scale_x)
            ...
            # (BASELINE_Y=120 means 8px transparent below feet → shift sprite down by that ratio)
            FRAME_H = 128
            BASELINE_Y = 120
            foot_pad = int(disp_h * (FRAME_H - BASELINE_Y) / FRAME_H)  # ~8px at native scale
