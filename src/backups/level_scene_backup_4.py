...
class LevelScene(Scene):
    ...
    def on_enter(self, **kwargs):
        ...
        if self.level == 1:
            self.temple_gate_img = self.assets.load_image("temple_gate.png", "items", alpha=True, scale=(120, 160))
    ...
    def draw(self, surface):
        ...
        if self.level == 1 and self.temple_gate_img:
            # Draw gate centered on the last platform (x=1740, width=160, top=H-120)
            gate_x = 1740 + (160 - 120) // 2
            gate_y = (LOGICAL_HEIGHT - 120) - 160
            surface.blit(self.temple_gate_img, (gate_x, gate_y))
            ...
            if self.box_system.goal_found:
                ...
                surface.blit(glow_surf, (gate_x - 10, gate_y - 10))
            ...
            if self.player.rect.colliderect(gate_rect):
                ...
                surface.blit(bg_surf, (px - 10, py - 5))
