...
## 6. Level 3 Drown Sprites (the lake)
In Level 3 the floor is the lake: touching it sinks the devotee for 1.5s before they rise again on the last golden platform. The game plays these strips over that 1.5s. They are **optional** — until they exist the game sinks the normal sprite below the waterline in code.

*   **Files:** `assets/images/sprites/player_boy_drown.png`, `assets/images/sprites/player_girl_drown.png`
*   **Format:** one horizontal strip per character, **4 frames, every frame square** (the engine derives the frame count from width ÷ height). Front view, so one strip serves both facing directions (like the bowing sprites).
*   **Tone:** gentle and kid-friendly — surprise, splash, calm. No fear, panic or distress.

*   **`player_boy_drown.png`**
    *   **Prompt:** `A 4-frame horizontal sprite strip, four equal square frames side by side, of a young Indian boy pilgrim (age 10-12, short neat black hair, warm brown skin, calm face, white long-sleeve kurta, white dhoti, white dupatta draped diagonally across his chest), front view facing the camera, gently sinking into calm lake water. Frame 1: he drops in up to his ankles with a small round splash, arms lifted slightly in surprise. Frame 2: water at his waist, splash droplets in the air, arms raised. Frame 3: water at his shoulders, only his head and raised hands above the surface, a few bubbles, eyes calmly closed. Frame 4: he is fully under; only ripple rings and a few rising bubbles remain. The water surface is a thin flat teal band with soft white ripple rings, at exactly the same height near the bottom of every frame. Kid-friendly and gentle, no fear, no panic, no distress. Clean 2D hand-drawn cartoon game sprite, dark ink outlines, soft cel shading, isolated on a pure white background.`
*   **`player_girl_drown.png`**
    *   **Prompt:** `A 4-frame horizontal sprite strip, four equal square frames side by side, of a young Indian girl pilgrim (age 10-12, long black hair in a high ponytail, small red bindi, warm brown skin, calm face, off-white long kurta with a white dupatta draped across her chest and shoulder, loose white dhoti-style trousers), front view facing the camera, gently sinking into calm lake water. Frame 1: she drops in up to her ankles with a small round splash, arms lifted slightly in surprise. Frame 2: water at her waist, splash droplets in the air, arms raised. Frame 3: water at her shoulders, only her head and raised hands above the surface, a few bubbles, eyes calmly closed. Frame 4: she is fully under; only ripple rings and a few rising bubbles remain. The water surface is a thin flat teal band with soft white ripple rings, at exactly the same height near the bottom of every frame. Kid-friendly and gentle, no fear, no panic, no distress. Clean 2D hand-drawn cartoon game sprite, dark ink outlines, soft cel shading, isolated on a pure white background.`
*   **Negative prompt:** use the standard block from Section 5, Part C.
*   **Post-processing:** cut into 4 equal squares; align the water line at the same y in every frame; scale frame 1's character to the same height as the idle strip; save the boy's strip at **512×128** (matching his other strips) — the girl's may be larger (e.g. 2880×720), as long as frames stay square.
## 7. Level 3 Tired Bird (optional)
The bird that falls onto the lotus in Level 3. **Optional** — until it exists the game tilts a wings-folded flight frame onto the lotus.

*   **File:** `assets/images/sprites/bird_fallen.png` — one image, **square**, bird facing **right**, transparent background (the game mirrors it when needed and scales it to 84×84).
*   **Prompt:** `A single 2D game sprite of a small songbird matching this style: dark brown-grey wings and back, warm orange breast, dark head, small yellow beak, flat colours with a clean dark-brown outline. The bird is resting tired on its side on a flat surface, wings folded, eyes half closed, facing right. Gentle and kid-friendly: tired, not injured — no blood, no wounds, no distress. Centred on a square canvas, isolated on a pure white background, no shadow, no text.`
*   **Negative prompt:** use the standard block from Section 5, Part C.
